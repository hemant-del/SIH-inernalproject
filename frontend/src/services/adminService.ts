...
export const adminService = {
  getOverview: async () => {
    try {
      ...
      return { totalUsers: 0, totalContacts: 0, totalAIConversations: 0 };
    }
  },

  getUsers: () => firestoreService.getAllUsers(),
  getContactRequests: () => firestoreService.getContactRequests(),
  getAIConversations: () => firestoreService.getAIConversations(),
